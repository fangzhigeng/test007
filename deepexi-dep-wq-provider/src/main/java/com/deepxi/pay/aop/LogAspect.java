 ...
 */
package com.deepxi.pay.aop;

import com.alibaba.fastjson.JSON;
import com.deepxi.pay.extension.AppRuntimeEnv;
...
public class LogAspect {
    ...
    @Pointcut("execution (* com.deepxi.pay.controller..*.*(..))")
    public void controllerLogAop() {
    }

    @Pointcut("execution (* com.deepxi.pay.service..*.*(..))")
